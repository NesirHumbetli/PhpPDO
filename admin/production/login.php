...
<head>
  ...
  <title>CV Porto Admin Panel </title>
      ...
      <div class="animate form login_form">
        <section class="login_content">
          <form action="../netting/process.php" method="POST">
            ...
            <div>
              <button style="background-color: #73879C;color: white;" type="submit" name="loggin" class="btn btn-default">Daxil Ol</button>
            </div>
            ...
            <div class="separator">
              <p class="change_link">
                ...
                } elseif (isset($_GET['status']) && $_GET['status'] == "exit") {
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Risein Studio</h1>
                <p>©2020 Bütün hüqüqlar qorunur.</p>
              </div>
            </div>
          </form>
        </section>
