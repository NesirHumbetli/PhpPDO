                            ...
                            <form action="../netting/process.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="text" id="first-name" placeholder="Menu Ad" name="menu_ad" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="text" id="first-name" placeholder="Menu Url girin" name="menu_url" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="text" id="first-name" placeholder="Menu sıra girin..." value="0" name="menu_sira" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div style="text-align: right;" class="col-md-8 col-sm-8 col-xs-12 col-sm-offset-3">
                                    <button type="submit" name="menukaydet" class="btn btn-primary">Saxla</button>
                                </div>
